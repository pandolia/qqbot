...
在 Python 2.7/3.4/3.5 下使用，用 pip 安装，安装命令：
...
除了上面提到的 onQQMessage 响应函数，还可以注册 onNewContact/onLostContact/onInterval 三种事件的响应函数，对应的事件以及函数参数格式及含义如下：
